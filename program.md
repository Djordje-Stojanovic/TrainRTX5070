...
**Minimum improvement threshold**: val_bpb improvements smaller than **0.003** are not reliably distinguishable from run-to-run variance. Don't keep a change that improves val_bpb by less than 0.003 unless it also simplifies the code.
