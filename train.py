...
def main():
    ...
    # Force batch=8: eager-mode autotune can't predict compiled+flex_attention VRAM accurately.
    # Compiled training uses ~8.8 GB at batch=4, ~3.4 GB headroom suggests batch=8 should fit.
    autotuned_candidate = (8, True)
